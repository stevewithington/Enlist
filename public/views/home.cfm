...
<cfoutput>
<h2><view:message key="message.hello"/></h2>
...
<ul>
	...
	<li><a href="#BuildUrl('user.list')#"><view:message key="message.hello"/></a></li>
	<li><a href="#BuildUrl('user.search')#"><view:message key="message.hello"/></a></li>
</ul>
<!--- 
